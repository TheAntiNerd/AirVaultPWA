...
const files = [{ name: 'File 1', size: '2MB', type: 'PDF', modified: '2024-12-1', shared: 'shiv@legiuon' },
{ name: 'File 2', size: '5MB', type: 'Image', modified: '2024-11-16', shared: 'shiv@legiuon' },
{ name: 'File 3', size: '1MB', type: 'Excel', modified: '2024-1-15', shared: 'shiv@legiuon' },
{ name: 'File 4', size: '1MB', type: 'Excel', modified: '2024-12-15', shared: 'shiv@legiuon' },
{ name: 'File 5', size: '1MB', type: 'Excel', modified: '2024-12-15', shared: 'shiv@legiuon' },
]
        ...
        <SideMenu>
            ...
            <div className="px-9 pt-6 text-sm">
                ...
                <div className="pb-4 flex justify-between items-center">
                    <h1 className="text-[22px] font-semibold">Shared with me</h1>

                </div>

                {files.length === 0 ? (
                    <div className="flex items-center justify-center flex-col space-y-3 pt-64">
                        <p className="text-[22px] font-medium">Nothing in here</p>
                        <p>Items deleted will be deleted forever after 30 days.</p>
                    </div>
                ) : (
                    <>
                        ...
                        <div className="text-center text-sm flex justify-between items-center">
                            <div className={`flex gap-3 ${selectedRow.length > 0 ? 'opacity-100' : 'opacity-0'}`}>
                                <button className="bg-gray-500 rounded-lg px-4 py-2">Restore</button>
                                <button className="bg-gray-500 rounded-lg px-4 py-2">Delete permanently</button>
                                    ...
                                    <table className="w-full border-collapse">
                                        <thead>
                                            <tr>
                                                ...
                                                <th className="py-4 text-left w-1/6">
                                                    <div className="flex flex-col items-start">Deleted on</div>
                                                </th>
