                ...
                {/* files empty */}
                {
                    files.length === 0 ? (<>
                        <div className="flex items-center justify-center flex-col gap-y-3 min-h-screen pb-80 ">
                            ...
                            <p className="text-primary-para max-sm:text-center">
                                ...
                                <tbody className="text-primary-para">
                                    {files.map((file, index) => (
                                        <tr
                                            ...
                                            className={`border-b max-sm:border-none border-border/40 relative ${selectedRow.includes(index) ? 'bg-selected' : 'group hover:bg-hover'}`}
                                        >
                                            <td className="py-2 w-1/5">
                                                <div className="flex flex-col items-start">
                                                    <span className="flex items-center justify-between">
                                                        ...
                                                        <span className="pl-3 flex flex-col gap-x-2">
                                ...
                                <div className='pb-10 cursor-default'>
                                    ...
                                    <div className=' grid grid-cols-3 gap-x-3 gap-y-6 max-sm:grid-cols-1 max-md:grid-cols-2 max-lg:grid-cols-2 xl:grid-cols-4'>
                                        {files.map((file, index) => (
                                            <div
                                                key={index}
                                                className={`h-[212px] w-[250px] max-sm:w-full rounded-lg bg-hover  ${selectedRow.includes(index) ? 'bg-selected' : 'group'}`}
                                                onClick={() => handleRowClick(index)}
                                            >
                                                <div className='bg-white relative rounded-md m-2.5 h-[140px] flex '>
                                                    ...
                                                    <div className={`absolute top-1 right-0 flex flex-row items-center gap-x-2  transition-opacity`}>
                                                        <div><button onClick={() => setSharePopup(!showSharePopup)} className="bg-buttonPrimary  opacity-0 group-hover:opacity-100 rounded-lg px-5 py-2 text-white max-sm:hidden">Share</button></div>
                                                        <div className="max-sm:hidden  opacity-0 group-hover:opacity-100"><CopyIcon /></div>
                                                        <div onClick={() => handleDropdownToggle(index)} className="rotate-90  cursor-pointer  sm:opacity-0 group-hover:opacity-100">•••</div>
                                                    </div>
