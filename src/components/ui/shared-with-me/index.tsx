                    ...
                    <tbody>
                        {files.map((file, index) => (
                            ...
                            >
                                ...
                                <td className="py-4 w-1/6">
                                    <div className="flex flex-col items-start">{file.shared}</div>
                                </td>
            ...
            <div className="px-9 pt-6 text-sm">
                ...
                {files.length === 0 ? (
                    <div className="flex items-center justify-center flex-col space-y-3 pt-64">
                        <p className="text-[22px] font-medium">Nothing has been shared with you yet</p>
                        <p>See all the items shared with you in ine place</p>
                    </div>
                ) : (
                    <>
                                    ...
                                    <table className="w-full border-collapse">
                                        <thead>
                                            <tr>
                                                ...
                                                <th className="py-4 text-left w-1/6">
                                                    <div className="flex flex-col items-start">Shared by</div>
                                                </th>
