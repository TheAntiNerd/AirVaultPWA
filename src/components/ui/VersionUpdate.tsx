		...
		<SideMenu>
			...
			">
				...
				<div className="flex items-center max-sm:fixed bottom-10 max-sm:w-full justify-center pt-4 max-sm:px-3">
					<button
						className="bg-[#298DFF] shadow shadow-gray-500/30 max-sm:w-full px-6 py-3 rounded-lg text-white font-medium flex flex-col items-center justify-center w-40 relative"
						onClick={handleClick}
						disabled={isLoading}>
