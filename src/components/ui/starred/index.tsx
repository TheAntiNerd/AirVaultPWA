        ...
        <SideMenu>
            ...
            <div className="px-9 pt-6 text-sm">
                ...
                <div className="pb-4 flex justify-between items-center">
                    <h1 className="text-[22px] font-semibold">Starred</h1>

                </div>

                {files.length === 0 ? (
                    <div className="flex items-center justify-center flex-col space-y-3 pt-64">
                        <p className="text-[22px] font-medium">No starred files</p>
                        <p>Add stars to things that you want to find easily later</p>
                    </div>
                ) : (
                    <>
