    ...
    return (
        <div className="relative ">
            ...
            <div
                ...
                className="py-1 px-4 border-2 border-border/80 focus:outline-none focus:border-buttonPrimary rounded-lg text-primary-heading font-medium cursor-pointer flex flex-row items-center gap-x-5"
            >
                {selected} <span className="mr-1.5"><DownArrow /></span>
            </div>

            {/* Dropdown Options */}
            {isOpen && (
                <ul ref={dropdownRef} className="absolute left-0 mt-1 w-full bg-white border-border/80 rounded-lg shadow-lg z-10 text-primary-para">
                    {options.map((option) => (
                        <li
                            key={option}
                            onClick={() => {
                            ...
                            className="group px-1 py-2 cursor-pointer hover:bg-[#D6ECFF] flex flex-row items-center gap-x-1 text-nowrap "
                        >
...
const Account: React.FC = () => {
    ...
    return (
        <div className="p-6 space-y-6 relative w-full  min-h-screen max-w-[1200px]">
            {/* Back button and title */}
            <div className="flex flex-row items-center gap-x-4">
                <span onClick={handleBack} className="cursor-pointer">
                    <BackbuttonIcon />
                </span>
                <h1 className="text-2xl font-semibold text-primary-heading">Accounts</h1>
            </div>
            ...
            <div className="w-[500px] mx-auto">
                ...
                <div>
                    <h2 className="text-lg font-semibold text-primary-heading">General info</h2>
                    <div className="mt-4 space-y-4">
                        <div className="flex items-center justify-between">
                            <label className="w-1/4 text-sm text-primary-para">Name</label>
                            <div>
                                <span className="text-primary-heading font-medium flex flex-row items-center gap-x-2">
                                    {newName}{' '}{newLastName} <span onClick={() => setEditNamePopup(!editNamePopup)} className="cursor-pointer"><EditPencilIcon /></span>
                                </span>
                            </div>
                        </div>
                        <div className="flex items-center justify-between gap-4">
                            <label className="w-2/4 text-sm text-primary-para">Email</label>
                            <span className="text-primary-heading font-medium">
                                ddpr@myairvault.com
                            </span>
                        </div>
                        <div className="flex items-center justify-between gap-4">
                            <label className="w-2/4 text-sm text-primary-para">Language</label>
                            <Dropdown
                        ...
                        <div className="flex items-center justify-between gap-4">
                            <label className="w-2/4 text-sm text-primary-para">Date format</label>
                            <Dropdown
                ...
                <div className="mt-12">
                    <h2 className="text-lg font-semibold text-primary-heading">
                        Default sharing settings
                    </h2>
                    <div className="mt-4 space-y-4">
                        <div className="flex justify-between items-center gap-4">
                            <label className="w-2/4 text-sm text-primary-para">Who has access</label>
                            <Dropdown
                        ...
                        <div className="flex items-center justify-between gap-4">
                            <label className="w-2/4 text-sm text-primary-para">What people can do</label>
                            <Dropdown
            ...
            {editNamePopup &&
                <div>
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                        <div ref={editNamePopupRef} className="bg-white p-6 rounded-lg shadow-lg w-[382px] relative">
                            ...
                            <div className="flex flex-row items-center space-x-3 mt-6 ">
                                <button onClick={() => setEditNamePopup(!editNamePopup)} className="flex flex-grow items-center justify-center text-primary-para">
                                    Cancel
                                </button>
                                <button
                                    onClick={() => { }}
